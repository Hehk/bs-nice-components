...
function createRender(className, tag, props, children, _) {
  var cls = {
    className: className
  };
  if (props) {
...
function make(tag, $staropt$star, styles) {
  ...
  var make$1 = function (props, children) {
    ...
    newrecord[/* render */9] = (function (param) {
        return createRender(className, tag, props, children, param);
      });
    return newrecord;
  };
  return /* module */[
...
var combineStyles = $$Array.append;

function addStyles(newStyles, x) {
  return make(x[/* __tag */0], /* Some */[x[/* __debugName */1]], $$Array.append(x[/* __styles */2], newStyles));
}

function AddStyles(NewStyles) {
  return (function (Component) {
      var __tag = Component[0];
      var component = Component[4];
      var __styles = $$Array.append(Component[/* __styles */2], NewStyles[/* newStyles */0]);
      var className = Nice.css(__styles);
      var make = function (props, children) {
        var newrecord = component.slice();
        newrecord[/* render */9] = (function (param) {
            return createRender(className, __tag, props, children, param);
          });
        return newrecord;
      };
      return /* module */[
